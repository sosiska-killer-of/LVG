...
function welcomelvg()
	...
	sm.gui.chatMessage(" ")
	sm.gui.chatMessage("-------------------------------------------------")
	sm.gui.chatMessage("thank you for playing LVG version 0.1")
	sm.gui.chatMessage("-------------------------------------------------")
	sm.gui.chatMessage("changelog:")
	sm.gui.chatMessage("added this thing")
	sm.gui.chatMessage("-------------------------------------------------")
end
...
function BasePlayer.server_onShapeRemoved( self, removedShapes ) end
