...
function CreativeGame.server_onPlayerJoined( self, player, newPlayer )
	...
	sm.gui.chatMessage("#00FF00thank you for playing LVG version 1.7")
	sm.gui.chatMessage("#000000-------------------------------------------------")
	sm.gui.chatMessage("#00FF00changelog:")
	sm.gui.chatMessage("#00FF00added gui")
	sm.gui.chatMessage("#000000-------------------------------------------------")
	sm.gui.chatMessage("#00FF00THIS MOD IS IN EARLY ACCES!")
	sm.gui.chatMessage("#00FF00ERRORS OR BUGS MIGHT ACCURE")
    sm.gui.chatMessage("#000000-------------------------------------------------")
...
CreativeTerrainGame.worldScriptFilename = "$CONTENT_DATA/Scripts/CreativeTerrainWorld.lua";
